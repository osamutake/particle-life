...
debug-build: dist/interact-particles.wasm dist/particle-life.js dist/index.html

dist/index.html: src/index.html
	cp src/index.html dist/index.html

dist/particle-life.wasm: src/particle-life.cpp
	$(CC) -o dist/interact-particles.wasm -g src/interact-particles.cpp -s EXPORTED_FUNCTIONS=_malloc,_free  --no-entry -s STANDALONE_WASM
...
clean:
	-@rm dist/interact-particles.wasm dist/particle-life.js obj/*
